        ...
        <div>
            ...
            <section className="bodycopySec">
                ...
                <div className="signaturebroucher-wrapper residence-item">
                    ...
                    <a href="/residences/kalpataru-azuro" className="ctaBluetext ">View Project <img src="images/signature-cta-arrow.svg" alt="" /></a>
                    </div>
                </div>
                <div className="signaturebroucher-wrapper residence-item">
                    <div className="signature-image">
                    ...
                    <div className="signature-content">
                        ...
                        <a href="/residences/kalpataru-prive" className="ctaBluetext">View Project <img src="images/signature-cta-arrow.svg" alt="" /></a>
                    </div>
                </div>
                <div className="signaturebroucher-wrapper residence-item">
                    <div className="signature-image">
                    ...
                    <div className="signature-content">
                        ...
                        <a href="/residences/kalpataru-oceana" className="ctaBluetext">View Project <img src="images/signature-cta-arrow.svg" alt="" /></a>
                    </div>
                </div>
