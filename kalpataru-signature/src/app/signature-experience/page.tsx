      ...
      <section className="signatureSec signExpimgsection" ref={experienceSec}>
        <div className="signatureWrapper">
          <div className="secHeading">
            ...
            >
              <span>An unparalleled experience of living. And of luxury.</span>
            </h2>
            <p
              className={`section-text-up ${
                experienceSection ? "newClass" : ""
            ...
            >
              <span>
                Luxury is a subtle art that reveals itself in the finer aspects
                of living. And our thoughtfully crafted residences, along with
                the premium amenities that surround them, all strive to be a
                true exhibitions of this rare art.
              </span>
            </p>
          </div>
        ...
        <div className="signatureWrapper">
          <div className="secHeading">
            <h2 className="section-text-up newClass">
              <span>Exclusive cultural events</span>
            </h2>
            <p className="section-text-up newClass">
              <span>Immerse in luxury of fine culture.</span>
            </p>
          </div>
        </div>
