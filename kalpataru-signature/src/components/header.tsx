        ...
        <header className="nav-down headerNew" id="main-header">
            <div className="headerWrapper">
                <div className="leftMenu">
                    <ul>
                        <li className="menuLinks"><a href="#philosophy">Philosophy</a></li>
                        <li className="menuLinks"><a href="#essence">Essence</a></li>
                    </ul>
                </div>
                ...
                <div className="rightMenu">
                    <ul>
                        <li className="menuLinks"><Link href={'/'}>Residences</Link></li>
                        <li className="menuLinks"><Link href={'/'}>Experience</Link></li>
                        <li>
                            <div className="hamburgerDiv" id="hamburgerDiv">
                                <div className="button_container" id="toggle"><span className="top"></span><span className="bottom"></span></div>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div className="overlay" id="overlay">
                <div className="popupmenuLogo"><Link href={'/'}><img src="/images/headerlogo.svg" alt="" title="" /></Link></div>
                <button className="closeButtonmenu"><img src="/images/popup-close-icon.svg" alt="" title="" /></button>
                <nav className="overlay-menu">
                    <ul>
                        <li className="menuLinks"><Link href={'/'}>Signature Philosophy</Link></li>
                        <li className="menuLinks"><Link href={'/'}>Signature Essence</Link></li>
                        <li className="menuLinks"><Link href={'/'}>Signature Residences</Link></li>
                        <li className="menuLinks"><Link href={'/'}>Signature Experience</Link></li>
